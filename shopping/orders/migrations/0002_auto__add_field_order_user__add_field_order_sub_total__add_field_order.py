...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'orders_order', 'tax_total',
                      self.gf('django.db.models.fields.DecimalField')(default=0.99, max_digits=1000, decimal_places=2),
                      keep_default=False)
    ...
    models = {
        ...
        u'orders.order': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'Start'", 'max_length': '120'}),
